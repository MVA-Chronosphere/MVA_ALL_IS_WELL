...
const BlogSection = () => {
  ...
  useEffect(() => {
    ...
    // Combine with default blogs if needed (or just use stored blogs)
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-10">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-serif font-bold text-[#002d72] leading-tight">
            Recent Health Awareness Blog
          </h2>
          <div className="w-16 h-1 bg-[#d4af37] mx-auto mt-4 rounded"></div>
          <p className="text-lg text-[#44] mt-4 max-w-2xl mx-auto">
            Stay informed with our latest health tips, medical insights, and awareness articles
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <button className="bg-[#001d52] text-white px-8 py-3 rounded-md hover:bg-[#001d52] transition-colors duration-300 font-medium">
            View All Articles
          </button>
        </div>
      </div>
