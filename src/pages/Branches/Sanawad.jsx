...
const SanawadBranch = () => {
  return (
    <BranchTemplate 
      ...
      location="Sanawad"
      galleryImages={[
        '/branches/sanawad/Sanawad-branch-1.jpg',
        '/branches/sanawad/Sanawad-branch-2.jpg',
        '/branches/sanawad/Sanawad-branch-3.jpg',
        '/branches/sanawad/Sanawad-branch-4.jpg',
        '/branches/sanawad/Sanawad-branch-5.jpg'
      ]}
