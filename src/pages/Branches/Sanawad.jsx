...
const SanawadBranch = () => {
  return (
    <BranchTemplate 
      branchName="All Is Well Super Clinic & Pathology, Sanawad"
      location="Sanawad"
      galleryImages={[
        '/branches/sanawad/Sanawad-branch-1.webp',
        '/branches/sanawad/Sanawad-branch-2.webp',
        '/branches/sanawad/Sanawad-branch-3.webp',
        '/branches/sanawad/Sanawad-branch-4.webp',
        '/branches/sanawad/Sanawad-branch-5.webp'
      ]}
      ...
      ambulanceService={{
        ...
        contact: "Emergency: +91 89188 49211",
        serviceArea: "Sanawad and surrounding areas"
      }}
    />
  );
};

export default SanawadBranch;
