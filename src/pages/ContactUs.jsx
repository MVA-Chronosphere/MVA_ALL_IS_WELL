...
const ContactUs = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_ey9to09",   // 🔧 Replace with your EmailJS Service ID
        "template_4qxn3ul",  // 🔧 Replace with your Template ID
        form.current,
        "rEaE0gSCgvgy2DSpy"    // 🔧 Replace with your Public Key
      )
      .then(
        (result) => {
      ...
      <section id="map" className="py-20 bg-[#f9f9f9]">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="w-full rounded-lg shadow-lg overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3717.627330738039!2d76.19960731165531!3d21.286214378802946!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd83359d9be1d41%3A0x7b2e4ebc56afff4b!2sAll%20Is%20Well%20Hospital!5e0!3m2!1sen!2sin!4v1759205536921!5m2!1sen!2sin"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen=""
