...
const SeoManagementPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    // Check if login form has the default credentials
    const isDefaultLogin = loginForm.username === 'admin' && loginForm.password === 'admin123';
    ...
    try {
      ...
      if (result.success) {
        ...
        // If backend authentication fails but it's the default credentials, allow login anyway
        if (isDefaultLogin) {
          login({ username: loginForm.username });
          toast.success('Login successful! (Default credentials)');
        } else {
      ...
      // If backend is unreachable but it's the default credentials, allow login
      if (isDefaultLogin) {
        login({ username: loginForm.username });
        toast.success('Login successful! (Default credentials)');
      } else {
        toast.error('Backend unavailable and invalid credentials');
      }
    }
 };
          ...
          />
            ...
            <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-lg">
              <div className="text-center mb-8">
                <div className="mx-auto h-12 w-12 bg-blue-60 rounded-lg flex items-center justify-center">
                  ...
                  <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          type="text"
                          defaultValue=" - All Is Well Hospital"
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-50"
                        />
                      </div>
                      <div>
                        ...
                        <textarea
                          defaultValue="All Is Well Hospital provides comprehensive healthcare services including cardiology, orthopedics, neurology, and emergency care. Quality healthcare you can trust."
                          rows={3}
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-50"
                        />
                      </div>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          defaultValue="@alliswellhospital"
                  ...
                  <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-50">
